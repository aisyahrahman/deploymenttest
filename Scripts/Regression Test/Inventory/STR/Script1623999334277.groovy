...
WebUI.click(findTestObject('Object Repository/STR/img_Loading_ctl00_MainContent_InventoryTransferRequestDetail1_cbpInventoryTransferRequestDetails_ASPxRoundPanel1_formInventoryTransferRequest_cbFromWarehouse_cbWarehouse_B-1Img'))
...
WebUI.click(findTestObject('Deployment test/STR (1)/span_Post'))
