...
WebUI.click(findTestObject('Deployment test/STR/div_Post  New'))
...
WebUI.setText(findTestObject('Object Repository/Deployment test/STR/input__ctl00MainContentInventoryTransferReq_880720'), 
    'Deployment Test'+seq)
...
WebUI.click(findTestObject('Deployment test/STR/draft/div_Save Draft'))
