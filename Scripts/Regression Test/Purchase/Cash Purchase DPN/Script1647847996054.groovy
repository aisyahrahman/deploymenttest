...
WebUI.waitForElementClickable(findTestObject('Deployment test/Cash Purchase Post/img_Loading_ctl00_MainContent_CashPurchaseD_ca3425'), 
    0)
...
WebUI.click(findTestObject('Object Repository/Deployment test/Cash Purchase Post/PN/div_Post  New'))
