...
WebUI.click(findTestObject('Object Repository/Deployment test/AP/APP/input_SHOPEE_ctl00MainContentAPPaymentDtlcb_83b2ea'), 
...
WebUI.click(findTestObject('Deployment test/AP/APP/PN/div_Post  New'))
...
WebUI.click(findTestObject('Deployment test/AP/APP/Draft/div_Save Draft'))
