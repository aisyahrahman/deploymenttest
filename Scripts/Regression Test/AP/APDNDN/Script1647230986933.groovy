...
WebUI.setText(findTestObject('Object Repository/Deployment test/AP/APDN/input__ctl00MainContentAPDebitNoteDtlcbpAPD_b6b9a7'),seq)
...
WebUI.click(findTestObject('Object Repository/Deployment test/AP/APDN/input_Description_ctl00MainContentAPDebitNo_36e256'), 
...
WebUI.click(findTestObject('Deployment test/AP/APDN/PN/div_Post  New'))
...
WebUI.click(findTestObject('Deployment test/AP/APDN/Draft/div_Save Draft'))
