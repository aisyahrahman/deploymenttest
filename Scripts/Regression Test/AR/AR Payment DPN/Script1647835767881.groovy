...
WebUI.click(findTestObject('Object Repository/Deployment test/AR/ARP/input_OTHERS_ctl00MainContentARPaymentDtlcb_47bc52'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(5)

WebUI.setText(findTestObject('Object Repository/Deployment test/AR/ARP/input_OTHERS_ctl00MainContentARPaymentDtlcb_47bc52'), 
    '5')
...
WebUI.click(findTestObject('Deployment test/AR/ARP/PN/div_Post  New'))
...
WebUI.click(findTestObject('Deployment test/AR/ARP/Draft/div_Save Draft'))
