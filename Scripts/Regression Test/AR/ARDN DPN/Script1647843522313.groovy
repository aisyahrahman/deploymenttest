...
WebUI.click(findTestObject('Object Repository/Deployment test/AR/ARDN/input_Description_ctl00MainContentARDebitNo_18066d'), 
...
WebUI.click(findTestObject('Deployment test/AR/ARDN/PN/div_Post  New'))
...
WebUI.click(findTestObject('Deployment test/AR/ARDN/Draft/div_Save Draft'))
